...
version = get_version("django_18_fast_migrations", "__init__.py")
...
setup(
    name='django_18_fast_migrations',
    version=version,
    description="""Fast migrations from Django 1.10 backported into Django 1.8""",
